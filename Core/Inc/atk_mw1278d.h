...
/* 引脚定义 */
#define ATK_MW1278D_AUX_GPIO_PORT           GPIOB
#define ATK_MW1278D_AUX_GPIO_PIN            GPIO_PIN_5
#define ATK_MW1278D_AUX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)
#define ATK_MW1278D_MD0_GPIO_PORT           GPIOB
#define ATK_MW1278D_MD0_GPIO_PIN            GPIO_PIN_7
#define ATK_MW1278D_MD0_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOB_CLK_ENABLE();   \
