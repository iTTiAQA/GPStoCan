...
/* 引脚定义 */
#define ATK_MW1278D_UART_TX_GPIO_PORT           GPIOA//B into A
#define ATK_MW1278D_UART_TX_GPIO_PIN            GPIO_PIN_9
#define ATK_MW1278D_UART_TX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)

#define ATK_MW1278D_UART_RX_GPIO_PORT           GPIOA//B into A
#define ATK_MW1278D_UART_RX_GPIO_PIN            GPIO_PIN_10
#define ATK_MW1278D_UART_RX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)

#define ATK_MW1278D_TIM_INTERFACE               TIM4
#define ATK_MW1278D_TIM_IRQn                    TIM4_IRQn
#define ATK_MW1278D_TIM_IRQHandler              TIM4_IRQHandler
#define ATK_MW1278D_TIM_CLK_ENABLE()            do{ __HAL_RCC_TIM4_CLK_ENABLE(); }while(0)
#define ATK_MW1278D_TIM_PRESCALER               7200

#define ATK_MW1278D_UART_INTERFACE              USART1//3 to 1
#define ATK_MW1278D_UART_IRQn                   USART1_IRQn
#define ATK_MW1278D_UART_IRQHandler             USART1_IRQHandler
#define ATK_MW1278D_UART_CLK_ENABLE()           do{ __HAL_RCC_USART1_CLK_ENABLE(); }while(0)
